...
const DesignEdit = ({openModal, initData, refreshDesign, groupId}) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Form.Item name="image_front" className='font-bold' label={<label style={{ minWidth: '100px'}}>Image front</label>}>
                    <Input />
                </Form.Item>
                <Form.Item name="image_back" className='font-bold' label={<label style={{ minWidth: '100px'}}>Image back</label>}>
                    <Input />
                </Form.Item>
